...
""" % bcb_dev)
  ...
  #Print ASCII
  script.Print(" ******************************************");
  script.Print(" *         ___       _______ ___   ___    *"); 
  script.Print(" *        /   \     |   ____|\  \ /  /    *");
  script.Print(" *       /  ^  \    |  |__    \  V  /     *");
  script.Print(" *      /  /_\  \   |   __|    >   <      *");
  script.Print(" *     /  _____  \  |  |____  /  .  \     *");
  script.Print(" *    /__/     \__\ |_______|/__/ \__\    *");
  script.Print(" *                                        *");
  script.Print(" *    .___  ___.   ______    _______      *"); 
  script.Print(" *    |   \/   |  /  __  \  |       \     *");
  script.Print(" *    |  \  /  | |  |  |  | |  .--.  |    *");
  script.Print(" *    |  |\/|  | |  |  |  | |  |  |  |    *");
  script.Print(" *    |  |  |  | |  `--'  | |  '--'  |    *");
  script.Print(" *    |__|  |__|  \______/  |_______/     *");
  script.Print(" *                                        *");
  script.Print(" ******************************************");
  script.Print(" *   By: DennySPB    By: -ishubhamsingh   *");
  script.Print(" ******************************************");
  script.Print(" ")
